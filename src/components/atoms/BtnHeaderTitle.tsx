...
export default function BtnHeaderTitle({ btnValue = 'nothing' }: PropsType) {
  const rightModeStyle =
    'text-#0c0a09v bg-white font-bold uppercase px-3 py-1 text-xs mr-1 mb-1 mt-3 ml-8 w-1/4 h-10 border border-2 border-gray-700';
  const darkModeStyle =
    'text-slate-400 bg-slate-800 font-bold uppercase px-3 py-1 text-xs mr-1 mb-1 mt-3 ml-8 w-1/4 h-10';
